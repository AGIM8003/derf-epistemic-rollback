# BUILD_AND_IMPROVE — derf-epistemic-rollback
...
"@
  ...
  Set-Content -LiteralPath (Join-Path D:\00.AGIM PUBLICATIONS\01.PUBLISHED PROJECTS\DERF_PUBLICATION_PACKAGE_2026-07-16\CODE FOLDER 'README.md') -Encoding utf8 -Value @"
# CODE FOLDER — derf-epistemic-rollback
...
"@
  ...
  Set-Content -LiteralPath (Join-Path D:\00.AGIM PUBLICATIONS\01.PUBLISHED PROJECTS\DERF_PUBLICATION_PACKAGE_2026-07-16\CODE FOLDER 'run_tests.py') -Encoding utf8 -Value @"
#!/usr/bin/env python3
